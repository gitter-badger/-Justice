...
<body>
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/">Cafe Java</a>
			</div>
	...
	<div id="main">
		<div class="container">
			<div class="row">
				<div class="full">
					<h1 class="section-header text-center">Welcome to <span itemprop="name">Cafe management</span></h1>
				</div>
			</div>
